...
public class UserSubjectRetriever {
    ...
    public UserSubject findByUserIdAndYearAndSemester(final Long userId, final int year, final String semester){
    ...
    public UserSubject findByUserIdAndId(final Long userId, final Long userSubjectId) {
